  ...
  googleBusinessProfile: {
    ...
    triggers: [
      { id: 'reviewsSnapshot', label: 'On new review (snapshot poll)', fields: [
        ...
        outputFields: [
          { label: 'Review ID', path: 'reviews.0.name' },
          { label: 'Rating', path: 'reviews.0.starRating' },
          { label: 'Comment', path: 'reviews.0.comment' },
          { label: 'Author', path: 'reviews.0.author.displayName' },
          { label: 'Create Time', path: 'reviews.0.createTime' },
        ],
      },
    ],
    actions: [
      { id: 'listAccounts', label: 'List accounts', fields: [],
        outputFields: [
          { label: 'Account ID', path: 'accounts.0.name' },
          { label: 'Account Title', path: 'accounts.0.accountTitle' },
        ],
      },
      { id: 'listLocations', label: 'List locations', fields: [
        ...
        outputFields: [
          { label: 'Location ID', path: 'locations.0.name' },
          { label: 'Location Title', path: 'locations.0.title' },
        ],
      },
      { id: 'getLocation', label: 'Get location', fields: [
        ...
        outputFields: [
          { label: 'Location ID', path: 'name' },
          { label: 'Location Title', path: 'title' },
      ...
      { id: 'getDailyMetrics', label: 'Get daily metrics', fields: [
        ...
        outputFields: [
          { label: 'Metric Data', path: 'dailyMetrics' },
        ],
      },
      ...
      { id: 'listPosts', label: 'List posts', fields: [
        ...
        outputFields: [
          { label: 'Post ID', path: 'posts.0.name' },
          { label: 'Post Summary', path: 'posts.0.summary' },
          { label: 'Post State', path: 'posts.0.state' },
        ],
      },
      { id: 'createPost', label: 'Create post', fields: [
        ...
        outputFields: [
          { label: 'Post ID', path: 'name' },
          { label: 'Post Summary', path: 'summary' },
          { label: 'Post URL', path: 'url' },
        ],
      },
